  ...
  return (
    <section id="treatments" className="pt-0 pb-12 sm:pt-2 sm:pb-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Loyalty Promo Badge */}
        <div className="flex justify-center mb-8">
          <div className="inline-flex items-center gap-3 bg-gradient-to-r from-primary/10 via-primary/5 to-primary/10 dark:from-primary-accent/15 dark:via-primary-accent/5 dark:to-primary-accent/15 border-2 border-primary dark:border-primary-accent rounded-full px-8 py-4 shadow-lg">
            <svg className="h-8 w-8 text-primary dark:text-primary-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />
            </svg>
            <span className="text-xl sm:text-2xl font-extrabold text-primary dark:text-primary-accent tracking-wide">
              {t('sections.treatments.loyaltyPromo')}
            </span>
          </div>
        </div>
